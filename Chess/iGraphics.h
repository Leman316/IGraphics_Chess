...
void iShowBMP(int x, int y, char filename[])
{
	...
	glTexImage2D(GL_TEXTURE_2D, 2, GL_RGB, TextureImage->sizeX, TextureImage->sizeY, 0, GL_RGB,GL_UNSIGNED_BYTE, TextureImage->data);
...
void iDelayMS(int milli){
	clock_t start_time = clock();
	clock_t end_time = milli + start_time;
